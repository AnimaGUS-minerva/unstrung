...
${SENDDAO} -v -v --fake --outpcap ${PCAP04} -i wlan0 -v  --instance 2 --dagid fd80:abcd::12 --sequence 1 --prefix 2001:db8::/38 --myid 2001:db8::abcd:1 --dest fe80::1200:00ff:fe64:6423 --target 2001:db8::abcd:2/128  2>&1 |
