...
ARGS="--pcapout $out --fake -i wlan0 -v --instanceid 42 --dagid 2001:db8:1::1 --prefix 2001:db8:0001::/48 --prefixlifetime 12 --grounded --storing --version 1 --sequence 10 --rank 2"
