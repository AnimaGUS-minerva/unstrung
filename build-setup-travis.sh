...
(cd .. && mkdir -p host/libpcap-1.6.2 && cd host/libpcap-1.6.2 && ../../libpcap-1.6.2/configure && make )
(cd .. && mkdir -p host/tcpdump-4.6.2 && cd host/tcpdump-4.6.2 && ../../tcpdump-4.6.2/configure && make )
