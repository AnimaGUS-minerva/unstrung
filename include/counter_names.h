...
enum packet_stats {
    ...
    PS_NEIGHBOUR_UNICAST_REACHABILITY,
    PS_NEIGHBOUR_UNICAST_TARGET_NS,
    PS_NEIGHBOUR_UNICAST_SOURCE_UNSPECIFIED,
    PS_NEIGHBOUR_MCAST_SOLICIT,
    PS_NEIGHBOUR_IGNORED,
    PS_NEIGHBOUR_SOLICIT,
    PS_NEIGHBOUR_ADVERT,
    PS_NEIGHBOUR_JOINASSISTANT_SOLICIT,
    PS_NEIGHBOUR_JOIN_QUERY_STARTED,
    PS_NEIGHBOUR_JOIN_QUERY_INPROGRESS,
    PS_NEIGHBOUR_JOIN_NEIGHBOUR_SOLICITATION,
    PS_NEIGHBOUR_JOIN_QUERY_ALREADY_DECLINED,
    PS_NEIGHBOUR_JOIN_QUERY_ALREADY_ACCEPTED,
    PS_NEIGHBOUR_JOIN_QUERY_NOCONNECTION,
    PS_MAX,
};
